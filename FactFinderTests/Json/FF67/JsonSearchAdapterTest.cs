...
namespace Omikron.FactFinderTests.Json.FF67
{
    ...
    public class JsonSearchAdapterTest : BaseTest
    {
        ...
        public void TestGetResult()
        {
            ...
            Assert.AreEqual(9, result.FoundRecordsCount);
            Assert.AreEqual(1, result.Count);
            Assert.AreEqual("242550", result[0].ID);
        }
        ...
        public void TestGetAfterSearchNavigation()
        {
            ...
            Assert.AreEqual(AsnGroupStyle.Slider, asn[1].Style);
            Assert.AreEqual("Preis", asn[1].Name);
            Assert.AreEqual("€", asn[1].Unit);
            Assert.AreEqual(10, asn[1].DetailedLinkCount);
            var slider = (AsnSliderItem)asn[1][0];
        ...
        public void TestGetCampaigns()
        {
            ...
            Assert.AreEqual("247968", pushedProducts[0].ID);
